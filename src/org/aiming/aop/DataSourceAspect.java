...
import org.aiming.utils.DynamicDataSource;
...
public class DataSourceAspect {
	...
	@Before(value = "execution(* org.aiming.service.impl.*.*(..))") 
...
//		DynamicDataSource.setDataSource(new BigDecimal(-1));
	...
	@After(value = "execution(* org.aiming.service.impl.*.*(..))") 
